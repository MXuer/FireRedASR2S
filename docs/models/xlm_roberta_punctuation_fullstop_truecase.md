...
```bash
conda run -n fireredasr2s python examples/test_xlm_roberta_punctuation.py --skip_model_load 1
```

Real model smoke test:

```bash
conda run -n fireredasr2s python examples/test_xlm_roberta_punctuation.py \
