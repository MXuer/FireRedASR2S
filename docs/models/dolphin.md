...
```bash
conda run -n fireredasr2s python examples/test_dolphin.py --skip_model_load 1
```

Real model smoke test:

```bash
CUDA_VISIBLE_DEVICES=4 conda run -n fireredasr2s python examples/test_dolphin.py \
