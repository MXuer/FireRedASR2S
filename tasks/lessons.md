...
- Treat both target and maximum sentence durations as pressure signals, not as permission to cut inside confirmed active speech; when no audio-safe boundary exists, keep merging and record that the pipeline is waiting for silence.
