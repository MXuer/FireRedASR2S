...
MODEL_LANGUAGE_SUPPORT: tuple[ModelLanguageSupport, ...] = (
    ...
    ModelLanguageSupport(
        ...
        languages=(
            ...
            "ko", "ms", "pt", "ru", "ta", "te", "th", "tr", "ur", "vi", "zh",
        ),
        aliases={
            "en": ("english", "en-us", "en-gb"),
        },
        notes="Fun-ASR-Nano-2512 official example describes 31 languages with timestamps.",
    ...
    ModelLanguageSupport(
        ...
        name="qwen3_asr_1_7b",
        languages=(
            "ar", "bn", "ca", "cs", "da", "de", "en", "es", "fa", "fi", "fr",
            "hi", "hu", "id", "it", "ja", "ko", "ms", "nl", "pl", "pt", "ru",
            "sv", "ta", "te", "th", "tr", "uk", "ur", "vi", "zh",
        ),
        aliases={
            "en": ("english", "en-us", "en-gb"),
        },
        notes="Qwen3-ASR supports 30 languages plus 22 Chinese dialects; ASR timestamps require external alignment unless configured otherwise.",
        has_native_punctuation=True,
        supports_batch=True,
    ),
    ModelLanguageSupport(
    ...
    ModelLanguageSupport(
        role="timestamp",
        name="funasr_native",
        languages=("ar", "bn", "de", "en", "es", "fa", "fr", "hi", "id", "it", "ja", "ko", "ms", "pt", "ru", "ta", "te", "th", "tr", "ur", "vi", "zh"),
