...
MODEL_LANGUAGE_SUPPORT: tuple[ModelLanguageSupport, ...] = (
    ...
    ModelLanguageSupport(
        ...
        languages=("vi",),
        aliases={"vi": ("vietnamese", "vi-vn")},
        notes="Vietnamese Whisper-family ASR vinai/PhoWhisper-large. Use a forced aligner for timestamps.",
        has_native_punctuation=True,
        supports_batch=True,
    ),
    ModelLanguageSupport(
        role="asr",
        name="whisper_th_large_v3_combined",
        languages=("th",),
        aliases={"th": ("thai", "th-th")},
        notes="Thai Whisper-family ASR biodatlab/whisper-th-large-v3-combined. Use a forced aligner for timestamps.",
        has_native_punctuation=True,
        supports_batch=True,
    ),
    ModelLanguageSupport(
    ...
    ModelLanguageSupport(
        ...
        aliases={
            ...
            "ur": ("urdu", "ur-in"),
            "or": ("odia", "oriya", "or-in"),
            "pa": ("punjabi", "panjabi", "pa-in"),
        },
        notes="AI4Bharat Cadence-Fast punctuation restoration for English and 22 official Indian languages. It does not provide ITN.",
        supports_batch=True,
    ),
    ModelLanguageSupport(
        role="punc",
