...
```text
semantic_asr.adapters.qwen3_forced_aligner.Qwen3ForcedAlignerTimestampProvider
```
...
CUDA_VISIBLE_DEVICES=4,5,6,7 conda run -n fireredasr2s \
  python semantic_asr/examples/run_fireredvad_whisper_qwenaligner_textpunc.py \
